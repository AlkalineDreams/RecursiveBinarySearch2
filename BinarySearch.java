...
public class BinarySearch {
	...
	public static boolean Search(int[] array, int key) {
		...
		//this function searches an array for a value using binary search in recursion.
		
		boolean found = false; //if the key is found in the array, this is returned as true. false by default.
		
		int position; //current place in array
	    int lowerBound = 0;
	    ...
	    if (lowerBound <= upperBound) {
	    	...
	    	if (array[position] == key) {
		    	...
		    	array = Arrays.copyOfRange(array, lowerBound, upperBound);
		    	Search(array, key);
